...
run_cmd+=$train_options
run_cmd+=$eval_loss_options
run_cmd+=$save_options
run_cmd+=$wandb_options

# delete training state to save disk space
python tools/del_training_state.py ${STORE_DIR} $$ &
